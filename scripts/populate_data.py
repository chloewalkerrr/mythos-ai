    ...
    try:
        ...
        gods = [
            ...
            God(
                ...
                domain="Travel, Thieves, Commerce, Communication",
                symbol="Caduceus",
        ...
        cabins = [
            Cabin(
                cabin_number=1,
                patron_god_id=gods[0].id,
                description="Zeus's cabin",
                color_scheme="White and Blue",
            ),
            Cabin(
                cabin_number=3,
                patron_god_id=gods[1].id,
                description="Poseidon's cabin",
                color_scheme="Blue and Green",
            ),
            Cabin(
                cabin_number=6,
                patron_god_id=gods[3].id,
                description="Athena's cabin",
                color_scheme="Gray and Blue",
            ),
            Cabin(
                cabin_number=11,
                patron_god_id=gods[7].id,
                description="Hermes's cabin",
                color_scheme="Brown and Orange",
            ),
            Cabin(
                cabin_number=7,
                patron_god_id=gods[5].id,
                description="Apollo's cabin",
                color_scheme="Gold and Yellow",
            ),
        ]
        db.add_all(cabins)
        db.commit()
        ...
        characters = [
            Character(
                ...
                age=16,
                gender="Male",
                parent_god_id=gods[1].id,
                cabin_id=cabins[1].id,
                description="Son of Poseidon, main protagonist",
                status="alive",
                first_appearance="The Lightning Thief",
            ),
            Character(
                name="Annabeth Chase",
                age=16,
                gender="Female",
                parent_god_id=gods[3].id,
                cabin_id=cabins[2].id,
            ...
            Character(
                ...
                age=23,
                gender="Male",
                parent_god_id=gods[7].id,
                cabin_id=cabins[3].id,
            ...
            Character(
                ...
                status="alive",
                first_appearance="The Titan's Curse",
            ),
            Character(
        ...
        weapons = [
            ...
            Weapon(
                name="Backbiter",
                weapon_type="Sword",
                material="Half Steel, Half Celestial Bronze",
        ...
        powers = [
            ...
            Power(
                name="Communication with Horses",
                power_type="Mental",
                power_level=7,
        ...
        character_powers = [
            CharacterPower(
                character_id=characters[0].id, power_id=powers[0].id, proficiency_level=10
            ),
            CharacterPower(
                character_id=characters[0].id, power_id=powers[2].id, proficiency_level=9
            ),
            CharacterPower(
                character_id=characters[0].id, power_id=powers[5].id, proficiency_level=8
            ),
            CharacterPower(
                character_id=characters[1].id, power_id=powers[1].id, proficiency_level=10
            ),
            CharacterPower(
                character_id=characters[4].id, power_id=powers[3].id, proficiency_level=9
            ),
            CharacterPower(
                character_id=characters[5].id, power_id=powers[4].id, proficiency_level=8
            ),
        ]
        ...
        books = [
            Book(
                ...
                isbn="9780786838653",
                summary=(
                    "Percy discovers he is a demigod and goes on a quest "
            ...
            Book(
                ...
                book_number=4,
                publication_date=date(2008, 5, 6),
                page_count=361,
                isbn="9781423101468",
                summary=(
                    "Percy navigates the Labyrinth to prevent Luke's "
                    "army from invading Camp Half-Blood"
                ),
            ),
            Book(
        ...
        locations = [
            Location(
                ...
                realm="Mortal",
                coordinates="40.8°N, 72.8°W",
            ),
            Location(
                name="Mount Olympus",
                location_type="Divine Palace",
                description="Home of the Olympian gods, located on the"
                " 600th floor of the Empire State Building",
                realm="Olympus",
            ),
            Location(
                name="Underworld",
        ...
        prophecies = [
            Prophecy(
                ...
                text=(
                    ...
                    "And see the world in endless sleep, the hero's soul, "
                    "cursed blade shall reap. A single choice shall "
                    "end his days, Olympus to preserve or raze."
                ),
        ...
        quests = [
            Quest(
                ...
                book_id=books[0].id,
                prophecy_id=prophecies[0].id,
            ),
            Quest(
                title="Save Camp Half-Blood",
        ...
        total_records = (
            ...
            + len(prophecies)
            + len(quests)
            + len(character_powers)
            + len(quest_participants)
            + len(quest_monsters)
        )
